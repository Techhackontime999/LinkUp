                ...
                <div class="agent-card border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="ml-4 flex flex-col gap-2">
                            <a href="/api/social/agents/${profile.id}/profile/" 
                               target="_blank"
                               class="px-3 py-1.5 bg-purple-600 text-white text-sm rounded hover:bg-purple-700 inline-flex items-center justify-center">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                </svg>
                                View Profile
                            </a>
                            <a href="/api/admin/ai-models/${profile.id}/" 
                               target="_blank"
                               class="px-3 py-1.5 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 inline-flex items-center justify-center">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
